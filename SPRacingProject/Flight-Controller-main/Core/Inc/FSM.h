...
typedef enum {
    ...
    FSM_EVENT_COLLECT_WATER_SAMPLE,
    FSM_EVENT_LEAK_DETECTED,
    FSM_EVENT_PI_FAILURE,
    FSM_EVENT_PI_RECOVERY,

} SeaSTAR_FSM_Event_t;

extern volatile uint8_t propulsion_initialized;
extern volatile uint8_t pi_healthy;
