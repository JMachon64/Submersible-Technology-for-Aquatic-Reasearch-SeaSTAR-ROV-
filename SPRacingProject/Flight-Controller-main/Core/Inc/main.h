...
/* Private defines -----------------------------------------------------------*/
#define Gyro_EXTI_Pin GPIO_PIN_13
#define Gyro_EXTI_GPIO_Port GPIOC
#define Mag_EXTI_Pin GPIO_PIN_14
#define Mag_EXTI_GPIO_Port GPIOC
...
#define IO_1_P7_Pin GPIO_PIN_8
#define IO_1_P7_GPIO_Port GPIOA
#define PWM3_Pin GPIO_PIN_11
#define PWM3_GPIO_Port GPIOA
#define PWM4_Pin GPIO_PIN_12
#define PWM4_GPIO_Port GPIOA
#define RC_CH5_Pin GPIO_PIN_4
#define RC_CH5_GPIO_Port GPIOB
